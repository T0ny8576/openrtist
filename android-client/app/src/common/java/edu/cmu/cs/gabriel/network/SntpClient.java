...
public class SntpClient {
    ...
    public boolean requestTime(String host, int timeout) {
        ...
        try {
            ...
            // TODO: randomizedRequestTime
            // TODO: Use elapsedRealtimeNanos()? Checkout Timestamp64 Class
            ...
            checkValidServerReply(leap, mode, stratum, transmitTime, referenceTime,
                    requestTime, originateTime);
            long totalTransactionDurationMillis = responseTicks - requestTicks;
            long serverDurationMillis = transmitTime - receiveTime;
            long roundTripTime = totalTransactionDurationMillis - serverDurationMillis;
            // According to RFC4330:
            // t is the system clock offset (the adjustment we are trying to find)
            // t = ((T2 - T1) + (T3 - T4)) / 2
            long clockOffset = ((receiveTime - originateTime) + (transmitTime - responseTime)) / 2;
            Log.d(TAG, "NTP server: " + address + ", RTT: " + roundTripTime + ", Clock Offset: " + clockOffset);
    ...
    private static void checkValidServerReply(
            ...
            long referenceTime, long requestTime,
            long originateTime) throws InvalidServerReplyException {
        ...
        if (referenceTime == 0.) {
            throw new InvalidServerReplyException("zero referenceTime");
        }
    }
